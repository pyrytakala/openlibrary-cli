...
exampleResource
  ...
  .addHelpText("after", "\nExamples:\n  openlibrary-cli examples list\n  openlibrary-cli examples list --limit 5 --json")
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .option("--format <fmt>", "Output format: text, json, csv, yaml")
  .addHelpText("after", "\nExample:\n  openlibrary-cli examples get abc123")
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  openlibrary-cli examples create --name "My Example"')
  .action(async (opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  openlibrary-cli examples update abc123 --name "Updated"')
  .action(async (id: string, opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .argument("<id>", "Example ID")
  .option("--json", "Output as JSON")
  .addHelpText("after", "\nExample:\n  openlibrary-cli examples delete abc123")
  .action(async (id: string, opts: ActionOpts) => {
    try {
